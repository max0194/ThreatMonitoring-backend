...
func StartServer() {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://api.threatmonitoring.ru", "https://max0194.github.io", "https://max0194.github.io", "https://tauri.localhost", "http://tauri.localhost", "https://api.threatmonitoring.api"},
